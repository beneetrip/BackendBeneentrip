...
class StripeAPI
{
    ...
    /**
     * Client Identifier. Unique ID provided by the Stripe backend server to identify 
     * your application.
     *
     * @var string
     */
    ...
    /**
     * Creates a new StripeAPI instance. If the user doesn't know his token or doesn't have a
    ...
    /**
     * Retrieves a token from Stripe server, that will be used for all further API calls.
     *
     * @return array
     */
    ...
    public function createCustomer($email, $source) {
        ...
        $args = array("email" => $email, "source" => $source);

        return $this->callApi($headers, $args, $url, 'POST', 200, false);
    }
     ...
     * @return array
     */
    public function createCharge($amount, $currency, $customer) {
