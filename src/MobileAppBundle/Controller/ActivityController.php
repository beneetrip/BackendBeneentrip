...
class ActivityController extends Controller
{
	...
	public function modifierAction(){
		//$file = 'data.txt';
		// Écrit dans notre fichier pour garder les donnees
		//file_put_contents($file, $id."....".$request->libelle."....".$request->destination);
		...
		$activiteId = $em->getRepository('BusinessModelBundle:Activite')->myFindOne($id);
			...
			$em->flush();
				...
				$response = new Response(json_encode(array('success'=>'L\'activite a ete bien modifie')));
	...
	public function editAction()
    {
		...
		//$fp=fopen('data.txt', 'w');
		//fwrite($fp,$id."....".$request->libelle."....".$request->destination);
		//fclose($fp);
